...
if df_linear_clean.empty:
    ...
    if not X_linear_train.empty:
        ...
        col_lin_m2.metric("Mean Squared Error (MSE)", f"{mse_linear:,.2f}")
        col_lin_m3.metric("Mean Absolute Error (MAE)", f"{mae_linear:,.2f}")
    else:
...
if df_rf_clean.empty:
    ...
    if not X_rf_train.empty:
        ...
        col_rf_m2.metric("Mean Squared Error (MSE)", f"{mse_rf:,.2f}")
        col_rf_m3.metric("Mean Absolute Error (MAE)", f"{mae_rf:,.2f}")
    else:
